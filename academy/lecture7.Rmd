...
$$
Looking at the formula, we see that the Brier score is just the mean square error of our forecasts. Using code that is very nearly identical to that used to compute RMSE in [Lecture 4](lecture4.html), we can compute the Brier score of each of our prediction models.
