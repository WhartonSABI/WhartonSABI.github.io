...
4. Following along with the notes in Lecture 1, in your newly created script, write code that (i) reads in the dataset "nba_shooting_small.csv" and (ii) adds columns for field goal percentage (FGP), three point percentage (TPP), and free throw percentage (FTP).
...
5. Execute the script. If it runs without error and produces the correct output, you can proceed onto Part 2 of this problem set. Otherwise, go back and edit your script.
