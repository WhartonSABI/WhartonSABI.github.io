...
ggplot(pbp_explosive, aes(x = defteam, fill = defteam)) +
  geom_bar() +
  labs(
    title = "Number of Explosive Plays Allowed by Defensive Team",
    x = "Defensive Team",
...
14. *Challenge*: Finally, let's visualize the relationship between explosive plays and yards to go with a heat map. First, run the following code below to obtain the needed columns for this plot.
...
```{r heat map}
ggplot(pbp_explosive_rate, aes(x = ydstogo, y = reorder(defteam, -explosive_rate), fill = explosive_rate)) +
  geom_tile(color = "white") +
  scale_fill_viridis_c(option = "C", direction = -1, name = "Explosive Rate") +
  labs(
    title = "Explosive Rate Allowed by Down and Defensive Team",
    x = "Yards to Go",
    y = "Defensive Team"
  ) +
  theme_minimal() +
...
What conclusions can you draw from the visualizations in this section? How are teams' defenses stacking up against explosive plays? How much should certain bins in this visualization be weighed over others?
