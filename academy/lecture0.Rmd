...
We have also created an RStudio Project file for you: [Moneyball.Rproj](Moneyball.Rproj). Download this file and save it directly inside your Moneyball folder (not inside `data` or `scripts`).
