...
1. Take a few minutes to read through the online notes for [Lecture 1](lecture1.html). Without doing any coding, see if you can understand what the code in each code block is doing.
