...
The `na.rm = TRUE` arguments tell R to ignore missing values when computing the mean and standard deviation. Armed with our `standardize()` function, we can add a column called zERA_all which transforms ERA to the standardized scale.
