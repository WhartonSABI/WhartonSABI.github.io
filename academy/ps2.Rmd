...
Review the notes from [Lecture 2](lecture2.html) and try to explain what each code block is doing.
...
5. Without executing the code below, see if you can figure out what it is doing.
...
* Now rerun the `select()` function from above to check that the NAs were replaced with zeros. 
