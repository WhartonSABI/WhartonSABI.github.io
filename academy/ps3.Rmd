...
Run the code below to create the tbl `batting_2014_2015`.
...
Then save the tbl `batting_2014_2015` to the file `"data/batting_2014_2015.RData"` using the `save()` function. We will return to this dataset in [Lecture 5](lecture5.html).
