...
Then save the tbl `batting_2014_2015` to the file `"data/batting_2014_2015.RData"` using the `save()` function. We will return to this dataset in [Lecture 4](lecture4.html).
