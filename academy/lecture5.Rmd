...
In [Lecture 4](lecture4.html), we used `pivot_wider()` and `pivot_longer()` to reshape batting data and build more advanced visualizations. Today, we will return to that dataset, start making predictions, and introduce the ideas that lead to linear regression.
